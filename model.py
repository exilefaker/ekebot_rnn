...
from tensorflow.contrib import legacy_seq2seq #Deprecated library for sequence-to-sequence models
...
class Model():
    def __init__(self, args, training=True):
        ...
        for _ in range(args.num_layers):
            ...
            if training and (args.output_keep_prob < 1.0 or args.input_keep_prob < 1.0):
                cell = rnn.DropoutWrapper(cell,
                                          ...
                                          state_keep_prob=args.output_keep_prob,
                                          #switched rnn style to variational RNN - 
                                          #applies a different style of dropout, to all
                                          #connections including recurrent ones
        ...
        inputs = tf.split(inputs, args.seq_length, 1) #splits input tensor into seq_length tensors along axis 1
